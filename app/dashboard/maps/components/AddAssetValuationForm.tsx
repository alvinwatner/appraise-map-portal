  ...
  return (
    <div>
      ...
      <div className="ml-4">
        ...
        <input
          className="w-full pl-2 py-2 placeholder:placeholder:text-sm placeholder:text-gray-400 rounded-md ring-1 ring-gray-200 text-sm"
          value={appraiser}
          type="text"
          onChange={(e) => {
        ...
        <input
          className="w-full pl-2 py-2 placeholder:placeholder:text-sm placeholder:text-gray-400 rounded-md ring-1 ring-gray-200 text-sm overflow-hidden whitespace-nowrap text-overflow-ellipsis"
          value={reportNumber}
          type="text"
          onChange={(e) => {
            var value = e.target.value;
