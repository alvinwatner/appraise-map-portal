...
export default function Page() {
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-0 left-8 z-10 p-4 w-1/3">
      ...
      <div className="absolute top-0 left-96 z-10 p-4 w-1/3">
        <Autocomplete
          onLoad={onLoad}
      ...
      <button
        className={`fixed bottom-10 right-10 z-50 p-4 rounded-full ${
          isAdding ? "bg-white cursor-pointer ring-2 ring-black" : "bg-yellow-400"
